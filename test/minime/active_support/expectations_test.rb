...
describe Model, :model do
  ...
  describe "attribute length" do
    describe "minimum" do
      it "validates explicit local object" do
        Model.new.must_validate_length_of minimum_length_attribute: { minimum: 5 }
      end

      it "validates described model" do
        must_validate_length_of minimum_length_attribute: { minimum: 5 }
      end
    ...
    describe "maximum" do
      it "validates explicit local object" do
        Model.new.must_validate_length_of maximum_length_attribute: { maximum: 5 }
      end

      it "validates described model" do
        must_validate_length_of maximum_length_attribute: { maximum: 5 }
      end
    ...
    describe "range" do
      describe "in" do
        it "validates explicit local object" do
          Model.new.must_validate_length_of range_in_length_attribute: { in: 3..5 }
        end

        it "validates described model" do
          must_validate_length_of range_in_length_attribute: { in: 3..5 }
        end
      ...
      describe "within" do
        it "validates explicit local object" do
          Model.new.must_validate_length_of range_within_length_attribute: { within: 3..5 }
        end

        it "validates described model" do
          must_validate_length_of range_within_length_attribute: { within: 3..5 }
        end
    ...
    describe "exact" do
      it "validates explicit local object" do
        Model.new.must_validate_length_of exact_length_attribute: { is: 5 }
      end

      it "validates described model" do
        must_validate_length_of exact_length_attribute: { is: 5 }
      end
